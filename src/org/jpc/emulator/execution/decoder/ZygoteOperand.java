...
public class ZygoteOperand {
    ...
    public static List<Integer> ops32 = Arrays.asList(OP_eAX, OP_eCX, OP_eDX, OP_eBX, OP_eSP, OP_eBP, OP_eSI, OP_eDI);

    public static List<Integer> ops64 = Arrays.asList(OP_rAX, OP_rCX, OP_rDX, OP_rBX, OP_rSP, OP_rBP, OP_rSI, OP_rDI);

    public static List<Integer> ops2 = Arrays.asList(OP_rAXr8, OP_rCXr9, OP_rDXr10, OP_rBXr11, OP_rSPr12, OP_rBPr13, OP_rSIr14, OP_rDIr15,
        OP_rAX, OP_rCX, OP_rDX, OP_rBX, OP_rSP, OP_rBP, OP_rSI, OP_rDI);

    public static List<Integer> ops3 = Arrays.asList(OP_ALr8b, OP_CLr9b, OP_DLr10b, OP_BLr11b, OP_AHr12b, OP_CHr13b, OP_DHr14b, OP_BHr15b);

    public static List<Integer> ops_st = Arrays.asList(OP_ST0, OP_ST1, OP_ST2, OP_ST3, OP_ST4, OP_ST5, OP_ST6, OP_ST7);

    public static List<Integer> ops_segs = Arrays.asList(OP_ES, OP_CS, OP_DS, OP_SS, OP_FS, OP_GS);
