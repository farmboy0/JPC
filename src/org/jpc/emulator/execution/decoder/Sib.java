...
public class Sib {
    public static Pointer Ptr32_04(PeekableInputStream input, int prefices) {
        ...
        switch (sib & 7) {
        case 0: /* EAX Base */
            base = Processor.EAX_INDEX;
            break;
        case 1: /* ECX Base */
            base = Processor.ECX_INDEX;
            break;
        case 2: /* EDX Base */
            base = Processor.EDX_INDEX;
            break;
        case 3: /* EBX Base */
            base = Processor.EBX_INDEX;
            break;
        case 4: /* ESP Base */
            seg = Prefices.getSegment(prefices, Processor.SS_INDEX);
            base = Processor.ESP_INDEX;
            break;
        case 5: /* #1 Base */
            offset = input.read32();
            break;
        case 6: /* ESI Base */
            base = Processor.ESI_INDEX;
            break;
        case 7: /* EDI Base */
