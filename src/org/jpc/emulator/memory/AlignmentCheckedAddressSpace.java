...
/**
 * Class that implements an alignment checking skin on another <code>AddressSpace</code> instance.
 * Access that are not alignment on the correct granularity will trigger a
 * {@link org.jpc.emulator.processor.ProcessorException} with the appropriate vector value.
 * @author Chris Dennis
 */
public class AlignmentCheckedAddressSpace extends AddressSpace {
    ...
    /**
     * Throws a <code>ProcessorException</code> if the access is not aligned to a word (two-byte)
     * boundary.
    ...
    /**
     * Throws a <code>ProcessorException</code> if the access is not aligned to a doubleword (four-byte)
     * boundary.
     * @param offset address to be read.
    ...
    /**
     * Throws a <code>ProcessorException</code> if the access is not aligned to a quad-word (eight-byte)
     * boundary.
     * @param offset address to be read.
     * @return int value read.
     */
    ...
    /**
     * Throws a <code>ProcessorException</code> if the access is not aligned to a octa-word
    ...
    /**
     * Throws a <code>ProcessorException</code> if the access is not aligned to a quadword (eight-byte)
     * boundary.
     * @param offset address to be read.
     * @param data value to write.
     */
