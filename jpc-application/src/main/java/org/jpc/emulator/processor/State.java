...
public final class State {
    ...
    private static void registersOnly(Processor cpu, Formatter formatter) {
        ...
        formatter.format("[%8X] [%8X] [%8X] [%8X] [%8X] [%8X] [%8X] [%8X] [%8X] [%08X]\n", cpu.r_eax.get32(), cpu.r_ebx.get32(),
            cpu.r_ecx.get32(), cpu.r_edx.get32(), cpu.r_esi.get32(), cpu.r_edi.get32(), cpu.r_ebp.get32(), cpu.r_esp.get32(), cpu.eip,
            flags);
    }
    ...
    private static void segmentsOnly(Processor cpu, Formatter formatter) {
        ...
        formatter.format("[%4X] [%4X] [%4X] [%4X] [%4X] [%4X]\n", cpu.cs.getSelector() & 0xFFFF, cpu.ds.getSelector() & 0xFFFF,
            cpu.es.getSelector() & 0xFFFF, cpu.fs.getSelector() & 0xFFFF, cpu.gs.getSelector() & 0xFFFF, cpu.ss.getSelector() & 0xFFFF);
    }
}
