 ...
 * <p>
 * The key function of this component is the interfacing between the PCI components and the
 * interrupt controller that forms part of the southbridge.
 * @author Chris Dennis
 */
public class PCIISABridge extends AbstractPCIDevice {
    ...
    /**
     * Constructs the (singleton) PCI-ISA bridge instance for attachment to a PCI bus.
     */
    public PCIISABridge() {
